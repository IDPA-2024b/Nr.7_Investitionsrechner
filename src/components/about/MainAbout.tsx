...
import { chakra, Stack, Text, Box, Flex, Image } from "@chakra-ui/react";
...
export function MainAbout({ onEasterEgg, clicksNeeded }: MainAboutProps) {
  const [amountOfClicks, setAmountOfClicks] = useState(0);

  function handleClick() {
    setAmountOfClicks((c) => c + 1);
    if (amountOfClicks === clicksNeeded) {
      onEasterEgg();
    }
  }
    ...
    <>
      <Box backgroundColor={"#86E7DB"}>
        ...
        >
          ...
          >
            Providing you with the best tools to help you manage your investment
            portfolio.
          </Text>
          <Flex
          ...
          >
            ...
            <Stack spacing={4}>
              <Text
                ...
                color="smalltext.base"
              >
                Our goal is it to improve and help you during your investing
                journey
              </Text>
              <Text
                fontSize="1.2rem"
                ...
                color="smalltext.base"
              >
                We believe that everyone should have access to the best tools to
