...
export function HomePage() {
  const benefits = [
    {
      ...
      content:
        "Our platform is designed to be as easy to use as possible and intuitive for new and old users.",
      icon: <FaHandSparkles />,
    },
    {
      heading: "Real-Time Data",
      content:
        "Our platform provides real-time updates on stock performance and earnings summaries.",
      icon: <CalendarIcon />,
    },
    {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Currently this is not possible but we are working on it.",
    },
    {
